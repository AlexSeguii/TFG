...
# URLs de JustWatch para prime video en español
url_es = 'https://www.justwatch.com/es/proveedor/amazon-prime-video'
...
try:
    df_existing = pd.read_csv('primevideo.csv')
...
df_combined.to_csv('primevideo.csv', index=False)
